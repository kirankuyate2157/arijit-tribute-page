            ...
            <div className="">
                <div className="w-full min-h-screen absolute ">
                    <img
                        ...
                        src="https://lh3.googleusercontent.com/W_yOqnKSDYyeVOY_AsXhuAtb6rW3vCL3GtJ9DA1GxWOrJfyeSOqzvTv_TkFHijdkVPXWutASBlRFPg=w2456-h1023-p-l90-rj"
                        alt="Hero img"
                    ...
                    <div className="   max-w-screen  flex ">
                        ...
                        <div className=" w-full md:flex md:flex-row  mt-96 md:mt-56 justify-end md:mr-32  bg-blend-darken ">
                            ...
                            <div className=" md:w-1/2 lg:w-1/2 ml-12  md:mt-9 ">
                                ...
                                <h4 className="font-medium md:mt-5 text-lg  text-gray-700">1987 - present</h4>
                                <p className="my-4 pr-4  text-black">Arijit Singh is an Indian singer and music composer. The recipient of several accolades including a National Film Award and six Filmfare Awards, he has recorded songs in several Indian languages and has established himself as one of the leading playback singers of Bollywood. </p>
                            </div>
                        </div>
                    </div>
                </div>
